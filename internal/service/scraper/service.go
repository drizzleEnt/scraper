...
func (s *service) ScrapSber() (err error) {

	// s.c.OnResponse(func(r *colly.Response) {
	// 	r.Headers.Set("Cookies", "ea06937f-0230-4387-8090-995a2c915050")
	// })

	// err = s.c.Visit("https://megamarket.ru/api/mobile/v1/securityService/session/start")
	// if err != nil {
	// 	return err
	// }
	...
	s.c.OnHTML(".catalog-items-list .catalog-item-mobile", func(h *colly.HTMLElement) {
		fmt.Println(h.ChildText(".item-title title"))
	})
...
func setSberHeaders(r *colly.Request) {
	r.Headers.Add("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8")
	r.Headers.Add("Accept-Language", "en-GB,en;q=0.5")
	r.Headers.Add("Accept-Encoding", "gzip, deflate, br")
	r.Headers.Add("Connection", "keep-alive")
	...
	r.Headers.Add("Sec-Fetch-Mode", "cors")
	r.Headers.Add("Sec-Fetch-Site", "same-origin")
	r.Headers.Add("ecom_token", "ea06937f-0230-4387-8090-995a2c915050")
	r.Headers.Add("sbermegamarket_token", "ea06937f-0230-4387-8090-995a2c915050")
}
