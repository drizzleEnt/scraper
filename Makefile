...
generate-scraper-api:
	...
	--validate_out lang=go:pkg/scraper --validate_opt=paths=source_relative \
	--plugin=protoc-gen-validate=bin/protoc-gen-validate \
	--grpc-gateway_out=pkg/scraper --grpc-gateway_opt=paths=source_relative \
